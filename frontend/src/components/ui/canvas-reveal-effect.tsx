...
// WebGL dot-matrix reveal effect, rendered inside CardSpotlight on hover.
// Adapted from the Aceternity UI pattern for a plain Vite + React project:
//   - no "use client" (Next.js App Router concept, meaningless in a Vite SPA)
//   - root container defaults to a transparent background instead of the
//     original's hardcoded bg-white — a white box flashing in on hover
//     would look broken against this project's dark console theme
...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn("h-full relative bg-transparent w-full", containerClassName)}>
      ...
      {showGradient && <div className="absolute inset-0 bg-gradient-to-t from-surface to-[84%]" />}
    </div>
  );
};
